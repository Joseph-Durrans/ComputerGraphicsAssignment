...
osg::Material* Assignment::PedestrianTrafficLightFacade::sm_pStopMaterial = 0;
osg::Material* Assignment::PedestrianTrafficLightFacade::sm_pGoMaterial = 0;

Assignment::PedestrianTrafficLightFacade::PedestrianTrafficLightFacade(std::string sName, osg::Node* pAsset, osg::Matrixf m, bool bVisible) : TrafficLightFacade(sName, pAsset, m, bVisible), m_pSelectTransform(new osg::MatrixTransform()), m_pRedLamp(0), m_pGreenLamp(0), m_pAmberLamp(0)
{
...
Assignment::PedestrianTrafficLightFacade::~PedestrianTrafficLightFacade()
{
}

osg::Node* Assignment::PedestrianTrafficLightFacade::rootNode()
{
    return m_pRoot;
}
...
void Assignment::PedestrianTrafficLightFacade::setState(LightState eState)
{
...
void Assignment::PedestrianTrafficLightFacade::toggleState()
{
...
#ifdef WALK_SHADER
bool PedestrianTrafficLightFacade::run(osg::Object* object, osg::Object* data)
{
